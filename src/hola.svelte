  ...
  <body>
    <main>
      <div class="header" bind:this={headerElement}>
        ...
        <p class="dato">Si hubieras comprado una acción de Apple en 1980 a 22$, hoy estaría valorada en $46,368.</p> 
      ...
      >
        ...
        <div slot="foreground" class="foreground_container">
          ...
          <section class="step_foreground">
            <div class="epi_foreground">
              <p class="texto">En este mismo evento se anuncia el <b>Apple Watch</b>, convirtiéndose en el reloj más vendido a nivel mundial en 2017.</p>
            </div>
          </section>
          <section class="step_foreground">
            <div class="epi_foreground">
